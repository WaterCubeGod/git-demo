...
<body>
    ...
    <form action="applicationServlet" enctype="multipart/form-data" method="post">
        ...
        <div>
            <!-- 文件选择和上传按钮 -->
            <input type="file" name = "fileName" id="fileSelecter">
        </div>
...
<%--        </div>--%>
        <input type="submit" onclick="uploadFile()" value="提交申请">
    </form>
    <a href="applicationLookServlet">查看申请进度</a>
    <a href="applicationHistory">查看申请失败记录</a>
    <div class="back-link">
